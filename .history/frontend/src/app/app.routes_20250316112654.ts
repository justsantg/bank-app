...
import { AdminComponent } from './components/admin/admin.component'; // ✅ Importar AdminComponent
...
export const routes: Routes = [
  ...
  { path: 'admin', component: AdminComponent }, // ✅ Ruta del Administrador
  { path: '**', redirectTo: '', pathMatch: 'full' } // Redirige cualquier ruta inválida a Home
];
