...
export class MovimientoController {
  ...
  // 🔥 Nuevo endpoint para obtener el último movimiento de un cliente
  @Get('ultimo/:clienteId')
  obtenerUltimoMovimiento(@Param('clienteId') clienteId: number) {
    return this.movimientoService.obtenerUltimoMovimiento(clienteId);
  }
